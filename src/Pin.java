...
public class Pin extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{        
            ...
            String b = t2.getText();
            String c = t3.getText();
            System.out.println("1."+a+"and"+Login.pass+".2");
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                ...
                else  if(!t1.getText().equals(Login.pass)) {
                	JOptionPane.showMessageDialog(null, "Please enter correct current pin ");
                	
                }
                
                else  if(a.equals(Login.pass)) {  
                    ...
                    conn c1 = new conn();
                    String q1 = "update signup set pin = '"+b+"' where pin = '"+a+"' ";
